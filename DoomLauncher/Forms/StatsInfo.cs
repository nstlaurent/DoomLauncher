    ...
    public partial class StatsInfo : Form
    {
        public StatsInfo()
        {
            ...
            lblZdoom.Text = "For all ZDoom based ports. Uses save games to parse statistics. This means statistics cannot be read for the last level of an episode. " +
                "Items are not available on ZDoom, Zandronum, and versions of GZDoom prior to 3.5.0. Statistics will be recorded when the game is saved or when an auto save is generated.";
