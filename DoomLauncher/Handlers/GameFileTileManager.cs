    ...
    class GameFileTileManager
    {
        ...
        private void ResetLayout()
        {
            ...
            if (m_factory.IsUsingTileView)
            {
                ...
                if (Tiles.Count == 0 || Tiles[0].GetType() != testTile.GetType() || Tiles[0].ImageWidth != testTile.ImageWidth || Tiles[0].Height != GameFileTile.GetImageHeight(testTile.ImageWidth))
                    RecreateLayout();
                else
                    UpdateLayout();
            }
