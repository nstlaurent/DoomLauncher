...
namespace UnitTest.Tests
{
    ...
    public class TestIdGamesTextInfo
    {
        ...
        {
            var info1 = new IdGamesTextInfo(null, "  ", null, "");
            Assert.AreEqual(0, info1.QualityScore);

            var info2 = new IdGamesTextInfo("Eviternity", "", null, null);
            ...
            var info5 = new IdGamesTextInfo("My House", "Steve Nelson", new DateTime(2023, 3, 2), "Just a normal regular wad just hanging out");
        ...
        {
            var info = new IdGamesTextInfo(null, null, null, null);
        ...
        {
            var info1 = new IdGamesTextInfo("Fancy Lands", "Rufus Wallykins", null, "Does not exist");
            var info2 = new IdGamesTextInfo("ignoreme", "ignore me", new DateTime(2024, 5, 3), "IGNORE ME");

            var result1 = info1.Combine(info2);
            Assert.AreEqual(new IdGamesTextInfo("Fancy Lands", "Rufus Wallykins", new DateTime(2024, 5, 3), "Does not exist"), result1);
